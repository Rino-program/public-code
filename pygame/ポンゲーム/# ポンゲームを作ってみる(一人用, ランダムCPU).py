...
# 物体
player_A = pygame.Rect(50, 250, 10, 120)
player_B = pygame.Rect(740, 250, 10, 120)
...
while True:
    ...
    # プレイヤーA(全自動)
    player_A.y = ball.y - player_A.height / 2 + ball.height / 2 + A
    # プレイヤーB
    if keys[pygame.K_UP]:
    ...
    if ball.left <= 0:
        ...
        ball_angle_deg = random.uniform(30, 330)  # 角度を度で表す
